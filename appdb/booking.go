...
type Booking struct {
	...
	ExchangeMailbox null.String `boil:"exchange_mailbox" json:"exchange_mailbox,omitempty" toml:"exchange_mailbox" yaml:"exchange_mailbox,omitempty"`
...
var BookingColumns = struct {
	...
	ExchangeMailbox: "exchange_mailbox",
...
var BookingTableColumns = struct {
	...
	ExchangeMailbox: "booking.exchange_mailbox",
...
var BookingWhere = struct {
	...
	ExchangeMailbox whereHelpernull_String
	...
	ExchangeMailbox: whereHelpernull_String{field: "\"ews\".\"booking\".\"exchange_mailbox\""},
...
var (
	bookingAllColumns            = []string{"id", "exchange_id", "exchange_uid", "exchange_mailbox", "booking_id"}
	bookingColumnsWithoutDefault = []string{}
	bookingColumnsWithDefault    = []string{"id", "exchange_id", "exchange_uid", "exchange_mailbox", "booking_id"}
